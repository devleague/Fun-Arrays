...
describe('Array Methods', function() {
  ...
  describe('sumOfHighInterests', function() {
    it('should be the sum of states in `bankBalances` excluding WI, IL, WY, OH, GA, DE where the interest added of 18.9% is greater than 50,000 - rounded to the nearest 10th', function() {
